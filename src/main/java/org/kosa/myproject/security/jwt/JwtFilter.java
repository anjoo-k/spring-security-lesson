...
/**
    ...
    JWT 인증 플로우 정리
    1. 클라이언트 -> 서버 : Authorization : Bearer token
    ...
    3. 유효한 토큰 : Spring Security Context에 인증 정보 저장
    4. Controller / Service 등에서 Security Context 에 저장된 인증 정보 사용
    5. 응답 후 Security Context 자동 제거(Stateless 유지) >> request 와서 response 되고 나면 끝! persistence context가 트랜잭션 끝나면 끝나듯이
 */
